...
public enum OrdaColumnType {
    ...
    OrdaColumnType(String targetType) {
    ...
    private static final Map<String, OrdaColumnType> LOOKUP = new HashMap<>();

    static {
        for (OrdaColumnType type : values()) {
            LOOKUP.put(type.name(), type);
        }
    }

    public static String map(String source) {
        OrdaColumnType mapping = LOOKUP.get(source.toUpperCase());
